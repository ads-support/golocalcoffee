...
import { TouchableOpacity, ScrollView, Text, StyleSheet, Platform, FlatList, View } from 'react-native';
    ...
    render() {
        ...
        return (
            <ScrollView style={styles.container}>
                ...
                <Text style={[styles.itemText, styles.headerText]}>Latest Posts</Text>
